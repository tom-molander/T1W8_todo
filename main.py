...
try: 
    ...
    todo_file.close()
    print ("Try block")
    # if error it means the file doesn't exist
    # if no error, it means file exists
...
print (f"{fg('black')}{bg('white')}Welcome to yout TODO list{attr ('reset')}")
...
def create_menu():
    ...
    print("4. Enter to view your to do list")
